module.exports = function console() {
	return `
      <div class="hidden p-4 rounded-lg" id="console" role="tabpanel" aria-labelledby="console-tab">
          ...
          <div id="consoleOutput" class="bg-darker-surface text-gray-300 p-4 rounded h-64 overflow-y-auto font-mono text-sm mb-4 border border-gray-700 whitespace-pre-wrap"></div>
